## Using try function with for_each in Terraform
...
[Blog post here](https://ashish.cloud/2024/07/22/dynamic-terraform-configurations-with-try-and-for_each-functions/)
